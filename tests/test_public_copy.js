...
describe('public copy: dest privacy and per-hasher hash bonus', () => {
  it('states dest privacy, Copy dest mining, per-hasher bonus; keeps She is Private; omits this is not and worthy coin', () => {
    ...
    assert.match(readme, /Wallet pin: \*\*0\.48\*\*/);
    ...
    assert.match(walletReadme, /releases\/tag\/0\.48/);
    assert.match(walletReadme, /shear-wallet-0\.48-windows\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.48-linux\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.48-archlinux\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.48-android\.apk/);
    ...
    assert.match(main, /Continuum GUI <strong>0\.48<\/strong>/);
    ...
    assert.match(main, /shear-wallet-0\.48-android\.apk/);
