...
describe('public copy: dest privacy and per-hasher hash bonus', () => {
  it('states dest privacy, Copy dest mining, per-hasher bonus; keeps She is Private; omits this is not and worthy coin', () => {
    ...
    assert.match(main, /Continuum 0\.53/);
    ...
    assert.match(readme, /Wallet pin: \*\*0\.53\*\*/);
    ...
    assert.match(walletReadme, /releases\/tag\/0\.53/);
    assert.match(walletReadme, /shear-wallet-0\.53-windows\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.53-linux\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.53-archlinux\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.53-fedora\.zip/);
    assert.match(walletReadme, /shear-wallet-0\.53-android\.apk/);
