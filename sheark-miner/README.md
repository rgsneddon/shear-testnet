...
- Banner: `ShearK-Miner 1.6 (ShearHash-v2 light)`
...
Default `--backend jit` is ShearHash-v2 light JIT + HARD_AES + huge pages (fallback to 4K if huge pages fail). Do not use `jit-full` against this pool: FULL_MEM hashes fail light verify.
