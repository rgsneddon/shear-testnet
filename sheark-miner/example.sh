#!/bin/sh
# Example launch for ShearK-Miner 1.2 (ShearHash-v2 light).
...
if [ ! -x ./ShearK-Miner ]; then
  echo "ShearK-Miner missing or not executable. Unpack ShearK-Miner-1.2-macos.zip or -linux.zip first."
  exit 1
fi
