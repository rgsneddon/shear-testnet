#!/bin/sh
# Example launch for ShearK-Miner 1.1 (ShearHash-v2 light).
...
if [ ! -x ./ShearK-Miner ]; then
  echo "ShearK-Miner missing or not executable. Unpack ShearK-Miner-1.1-macos.zip or -linux.zip first."
  exit 1
fi
