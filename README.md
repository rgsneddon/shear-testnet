...
- Wallet pin: **0.54** (GUI + CLI). Releases: https://github.com/rgsneddon/shear-testnet/releases/tag/0.54
...
Wallet **0.48** syncs a local node at `127.0.0.1:18332` (headers + compact blocks). It does not use the old height sampler. Public pool HTTP submit is an advanced toggle. Reserve Send shows your IP to the node. Use a VPN, then confirm **I already use a VPN / I accept exposing my IP** before Send. There is no Shear privacy hop.
