...
- Wallet pin: **0.37** (GUI + CLI). Releases: https://github.com/rgsneddon/shear-testnet/releases/tag/0.37
...
Wallet **0.37** syncs a local node at `127.0.0.1:18332` (headers + compact blocks). It does not use the old height sampler. Public pool HTTP submit is an advanced toggle.
