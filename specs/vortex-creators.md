...
On a Shear node (testnet `shear-testnet-v3`), call `store.mintVorticeDeployKey` with the program id, a short display name, the origin URL, and the **exact** bytes the origin will serve:
