# MacBook handoff — Apple wallet 0.40
...
| Asset | Pack host |
|-------|-----------|
| `shear-wallet-0.40-windows.zip` | Windows |
| `shear-wallet-0.40-android.apk` | Windows |
| `shear-wallet-0.40-linux.zip` | `77.42.91.84` |
| `shear-wallet-0.40-archlinux.zip` | `77.42.91.84` |
...
`https://github.com/rgsneddon/shear-testnet/releases/download/0.40/shear-wallet-0.40-macos.dmg`
