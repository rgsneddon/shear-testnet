# MacBook handoff — Apple wallet 0.35
...
**Wallet tag:** https://github.com/rgsneddon/shear-testnet/releases/tag/0.35  
...
| Asset | Pack host |
|-------|-----------|
| `shear-wallet-0.35-windows.zip` | Windows |
| `shear-wallet-0.35-android.apk` | Windows |
| `shear-wallet-0.35-linux.zip` | `77.42.91.84` |
| `shear-wallet-0.35-archlinux.zip` | `77.42.91.84` |
...
`https://github.com/rgsneddon/shear-testnet/releases/download/0.35/shear-wallet-0.35-macos.dmg`
