# MacBook handoff — Apple wallet 0.38
...
**Wallet tag:** https://github.com/rgsneddon/shear-testnet/releases/tag/0.38  
...
| Asset | Pack host |
|-------|-----------|
| `shear-wallet-0.38-windows.zip` | Windows |
| `shear-wallet-0.38-android.apk` | Windows |
| `shear-wallet-0.38-linux.zip` | `77.42.91.84` |
| `shear-wallet-0.38-archlinux.zip` | `77.42.91.84` |
...
`https://github.com/rgsneddon/shear-testnet/releases/download/0.38/shear-wallet-0.38-macos.dmg`
