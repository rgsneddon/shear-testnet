# MacBook handoff — Apple wallet 0.39
...
**Wallet tag:** https://github.com/rgsneddon/shear-testnet/releases/tag/0.39  
...
| Asset | Pack host |
|-------|-----------|
| `shear-wallet-0.39-windows.zip` | Windows |
| `shear-wallet-0.39-android.apk` | Windows |
| `shear-wallet-0.39-linux.zip` | `77.42.91.84` |
| `shear-wallet-0.39-archlinux.zip` | `77.42.91.84` |
...
`https://github.com/rgsneddon/shear-testnet/releases/download/0.39/shear-wallet-0.39-macos.dmg`
