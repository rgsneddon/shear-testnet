...
(function (P) {
  P.overview = {
    ...
    html:
      ...
      '<tr><th>Wallet pin</th><td>0.4</td></tr>' +
  ...
  P.testnet = {
    ...
    html:
      ...
      '<p>Mainnet is scheduled for <strong>21:00 UK time on 11 September 2026</strong>. Until then the magic stays <code>shear-testnet-v2</code>. Do not flip it early. Do not cut a mainnet genesis zip from these pages.</p>' +
  ...
  P.wallet = {
    ...
    html:
      '<p>The Shear wallet is a six-tab app. It does not mine. Current pin is <strong>0.4</strong> (macOS, Android, leftover Windows / Linux / Arch).</p>' +
  ...
  P.install = {
    ...
    html:
      ...
      '<p>Tag: <a href="https://github.com/rgsneddon/shear-testnet/releases/tag/0.4">shear-testnet 0.4</a>.</p>'
  };
