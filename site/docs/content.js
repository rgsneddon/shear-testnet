...
(function (P) {
  P.overview = {
    ...
    html:
      ...
      '<p>Private by default. Continuity-settled. Proof of work only. The live network today is <code>shear-testnet-v2</code>.</p>' +
  ...
  P.testnet = {
    ...
    html:
      ...
      '<p>Mainnet is scheduled for <strong>21:00 UK time on Friday 11 September 2026</strong>. Until then the magic stays <code>shear-testnet-v2</code>. Do not flip it early. Do not cut a mainnet genesis zip from these pages.</p>' +
