...
describe('docs.shear.digital', () => {
  it('is a file-tree browser with wallet, mining, vortex, vort1, reserve', () => {
    ...
    assert.match(content, /ShearK-Miner 1\.9/);
    ...
    assert.match(content, /Wallet pin<\/th><td>0\.34/);
    assert.match(content, /Current pin is <strong>0\.34<\/strong>/);
    assert.match(content, /releases\/tag\/0\.34/);
    ...
    assert.match(readme, /Wallet pin: \*\*0\.34\*\*/);
...
describe('whitepaper.shear.digital', () => {
  it('presents a Zenodo-style record with a PDF, and has no WHITEPAPER nav button', () => {
    ...
    assert.match(paper, /releases\/tag\/0\.34/);
