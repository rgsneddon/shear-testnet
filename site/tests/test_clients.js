...
describe('shear.digital client buttons', () => {
  it('places BIG WALLET / MINER / NODE buttons between the hero banner and the Shear box', () => {
    ...
    assert.match(html, /shear-wallet-0\.42-android\.apk/);
    assert.match(html, /releases\/download\/0\.42\/shear-wallet-0\.42-windows\.zip/);
    ...
    assert.match(html, /shear-wallet-0\.42-linux\.zip/);
    assert.match(html, /shear-wallet-0\.42-archlinux\.zip/);
    ...
    assert.match(html, /shear-wallet-0\.42-windows\.zip/);
    ...
    assert.match(html, /wallet <strong>0\.42<\/strong>/);
  ...
  it('puts emissions, governance, vortex columns and a full-width wallet box', () => {
    ...
    assert.match(html, /Continuum GUI <strong>0\.42<\/strong>/);
  ...
  it('admin how-to is Shear-only: wallet, mine, Reserve; no claim copy', () => {
    ...
    assert.match(admin, /shear-wallet-0\.42-/);
    assert.match(admin, /shear-wallet-0\.42-windows\.zip/);
    assert.match(admin, /shear-wallet-0\.42-android\.apk/);
