...
describe('shear.digital client buttons', () => {
  it('places BIG WALLET / MINER / NODE buttons between the hero banner and the Shear box', () => {
    ...
    assert.match(html, /shear-wallet-0\.12-windows\.zip/);
    assert.match(html, /shear-wallet-0\.12-android\.apk/);
    assert.match(html, /shear-wallet-0\.12-linux\.zip/);
    assert.match(html, /shear-wallet-0\.12-archlinux\.zip/);
    assert.doesNotMatch(html, /shear-wallet-0\.11-windows\.zip/);
    assert.doesNotMatch(html, /shear-wallet-0\.11-linux\.zip/);
    assert.doesNotMatch(html, /shear-wallet-0\.11-archlinux\.zip/);
