...
describe('shear.digital client buttons', () => {
  it('places BIG WALLET / MINER / NODE buttons between the hero banner and the Shear box', () => {
    ...
    assert.match(html, /shear-wallet-0\.47-android\.apk/);
    assert.match(html, /releases\/download\/0\.47\/shear-wallet-0\.47-windows\.zip/);
    ...
    assert.match(html, /shear-wallet-0\.47-linux\.zip/);
    assert.match(html, /shear-wallet-0\.47-archlinux\.zip/);
    ...
    assert.match(html, /shear-wallet-0\.47-windows\.zip/);
    ...
    assert.match(html, /wallet <strong>0\.47<\/strong>/);
  ...
  it('WALLET nav on MAIN MEMPOOL POOL EXPLORER pins 0.47 and refuses older tags', () => {
    ...
    for (const [name, page] of Object.entries(pages)) {
      assert.match(page, /releases\/tag\/0\.47/, `${name} WALLET must pin 0.47`);
  ...
  it('puts emissions, governance, vortex columns and a full-width wallet box', () => {
    ...
    assert.match(html, /Continuum GUI <strong>0\.47<\/strong>/);
  ...
  it('admin how-to is Shear-only: wallet, mine, Reserve; no claim copy', () => {
    ...
    assert.match(admin, /shear-wallet-0\.47-/);
    assert.match(admin, /shear-wallet-0\.47-windows\.zip/);
    assert.match(admin, /shear-wallet-0\.47-android\.apk/);
