...
def _font_pair():
    ...
    if (linux / "LiberationSerif-Regular.ttf").exists():
        return (
            linux / "LiberationSerif-Regular.ttf",
            linux / "LiberationSerif-Bold.ttf",
            linux / "LiberationSerif-Italic.ttf",
            linux / "LiberationSerif-BoldItalic.ttf",
        )
    raise FileNotFoundError("Times New Roman or Liberation Serif not found")
...
def main() -> None:
    ...
    body(
        pdf,
        "The wallet is a six-tab app, pin 0.49. Continuum is spendable balance, silent ID, and the six-slice pending pie. "
    ...
    body(
        ...
        "Shipped P2P seeds are p2p.shear.digital:30303, r2r.shear.digital:30303, b2b.shear.digital:30303, magic shear-testnet-v4. Wallet 0.49 reads a local node at 127.0.0.1:18332. "
    ...
    pdf.multi_cell(
        ...
        "Wallet pin at publication: 0.49.",
        new_x=XPos.LMARGIN,
        new_y=YPos.NEXT,
    )
    ...
    pdf.set_keywords("shear-testnet-v4 ADMITv2 wallet-0.49 ShearK-2.5, ShearHash-v3, Vortex, vort1, The Reserve")
