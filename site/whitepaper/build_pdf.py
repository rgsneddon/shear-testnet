...
def main() -> None:
    ...
    body(
        pdf,
        "The wallet is a six-tab app, pin 0.40. Continuum is spendable balance, silent ID, and the six-slice pending pie. "
    ...
    body(
        ...
        "Shipped P2P seeds are p2p.shear.digital:30303, r2r.shear.digital:30303, b2b.shear.digital:30303, magic shear-testnet-v4. Wallet 0.40 reads a local node at 127.0.0.1:18332. "
