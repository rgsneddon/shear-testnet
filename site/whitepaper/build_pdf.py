...
def main() -> None:
    ...
    body(
        pdf,
        "The wallet is a six-tab app, pin 0.43. Continuum is spendable balance, silent ID, and the six-slice pending pie. "
    ...
    body(
        ...
        "Shipped P2P seeds are p2p.shear.digital:30303, r2r.shear.digital:30303, b2b.shear.digital:30303, magic shear-testnet-v4. Wallet 0.43 reads a local node at 127.0.0.1:18332. "
    ...
    pdf.multi_cell(
        ...
        "Wallet pin at publication: 0.43.",
        new_x=XPos.LMARGIN,
        new_y=YPos.NEXT,
    )
    ...
    pdf.set_keywords("shear-testnet-v4 ADMITv2 wallet-0.43 ShearK-2.5, ShearHash-v3, Vortex, vort1, The Reserve")
