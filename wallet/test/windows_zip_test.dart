...
File _shippedWindowsZip() {
  final candidates = <File>[
    File('../dist/shear-wallet-0.34-windows.zip'),
    File('dist/shear-wallet-0.34-windows.zip'),
    File('${Directory.current.path}/../dist/shear-wallet-0.34-windows.zip'),
  ];
...
void main() {
  test('kWalletVersion public pin is two-part 0.34 (not 0.14.0)', () {
  ...
  test('built shear-wallet-0.34-windows.zip is a Flutter runner with no miner', () {
