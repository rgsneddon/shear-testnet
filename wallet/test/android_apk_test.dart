...
File _apk() {
  for (final p in [
    '../dist/shear-wallet-0.49-android.apk',
    'dist/shear-wallet-0.49-android.apk',
    '${Directory.current.path}/../dist/shear-wallet-0.49-android.apk',
  ]) {
    final f = File(p);
    if (f.existsSync()) return f;
  }
  return File('../dist/shear-wallet-0.49-android.apk');
}
...
void main() {
  test('0.49 APK is a fat installable package (applicationId, versionCode 71, INTERNET)', () {
    ...
    expect(int.parse(code!.group(1)!), 71);
