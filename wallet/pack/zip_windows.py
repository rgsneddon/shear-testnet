#!/usr/bin/env python3
"""Pack the Flutter Windows release tree into shear-wallet-0.20-windows.zip.
...
OUT_NAME = "shear-wallet-0.20-windows.zip"
...
# Keep the public pin two-part 0.20. Flutter file version 0.20.0+N is not the pin.
PUBLIC_PIN = "0.20"
