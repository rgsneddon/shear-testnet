...
| Client | Pin | Repo |
|--------|-----|------|
| Wallet | **0.38** | this tree, tag [`0.38`](https://github.com/rgsneddon/shear-testnet/releases/tag/0.38) |
| Miner | **ShearK 2.4** | [`rgsneddon/ShearK`](https://github.com/rgsneddon/ShearK/releases/tag/2.4) |
| Android APK | pack on **this Windows box** (see `HANDOFF_OPS.md` §6a) | `shear-wallet-0.38-android.apk` |
| macOS DMG | **MacBook handoff** (`HANDOFF_OPS.md` §6b) | `shear-wallet-0.38-macos.dmg` |
