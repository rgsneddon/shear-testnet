...
| Client | Pin | Repo |
|--------|-----|------|
| Wallet | **0.36** | this tree, tag [`0.36`](https://github.com/rgsneddon/shear-testnet/releases/tag/0.36) |
| Miner | **ShearK 2.4** | [`rgsneddon/ShearK`](https://github.com/rgsneddon/ShearK/releases/tag/2.4) |
| Android APK | pack on **this Windows box** (see `HANDOFF_OPS.md` §6a) | `shear-wallet-0.36-android.apk` |
| macOS DMG | **MacBook handoff** (`HANDOFF_OPS.md` §6b) | `shear-wallet-0.36-macos.dmg` |
